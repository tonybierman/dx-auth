...
//! least a given [`ResourceRole`](crate::ResourceRole) on a specific resource.
//!
...
/// Fetch the current user's [`ResourceRole`](crate::ResourceRole) on `(kind, id)`. Re-fetches when
